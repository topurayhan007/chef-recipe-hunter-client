...
const Header = () => {
  return (
    <div className="navbar bg-base-100 w-[1320px] mx-auto">
      ...
      <div className="navbar-end">
        <Link to="/login">
          <button className="btn normal-case text-lg">Login</button>
        </Link>
        <div className="dropdown dropdown-end">
          ...
          <ul
            tabIndex={0}
            className="mt-3 p-2 shadow menu menu-compact font-semibold dropdown-content bg-base-100 rounded-box w-52"
          >
            <li>
